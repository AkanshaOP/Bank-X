 ...
 */
export declare function readBarcodesWithFactory<T extends "reader" | "full">(zxingModuleFactory: ZXingModuleFactory<T>, input: Blob | ImageData, readerOptions?: ReaderOptions): Promise<ReadResult[]>;
/**
